...
1. Create a new repository in the `allsaintsfermentery` organization.
2. Add the `recipe` topic to the repository (Settings → Topics).
3. Add a `beer.yml` file at the root of the repository following the schema in [`beer.yml.example`](beer.yml.example).
